...
\textit{Lucile Packard Children's Hospital / Stanford Medical School.}  \dates{2021+} \\
\smaller{Creating new LLMs for inpatient intensive cardiac care and outpatient T1D management for pædiatrics. Won grants from Google.}
...
\textsc{Fellowship}. \textit{Stanford Medical School}. \dates{2025+}
